...
if ($conn->query($clr)) {
    ...
    for ($kk = 0; $kk < $tt; $kk++) {
        ...
        for ($k = 0; $k < $t; $k++) {
            ...
            if (array_key_exists('videoId', $v1)) {
                $id = $data0['items'][$k]['id']['videoId'];

            $url1 = "https://www.googleapis.com/youtube/v3/videos?part=snippet,status,contentDetails,statistics&id=$id&key=AIzaSyDtkydXbF1WEFsOBkm92lZCRNVGwCwFTNE";
